...
@tf_export('distribute.cluster_resolver.ElasticClusterResolver')
class ElasticClusterResolver(ClusterResolver):
  ...
  def __init__(self,
               ...
               rpc_layer=None,
               environment=None):
    """Creates a new ElasticClusterResolver.

    Args:
      config_fn: (function) A function that will get the current cluster spec
  ...
  def _get_value_in_config(self, key, default=None):
  ...
  def task_type(self):
    if self._task_type is None:
      task_info = self._get_value_in_config(_TASK_KEY, {})
  ...
  def rpc_layer(self):
    if self._rpc_layer is None:
      return self._get_value_in_config(_RPC_LAYER_KEY)
    else:
  ...
  def num_accelerators(self,
    ...
    return super(ElasticClusterResolver, self).num_accelerators(
  ...
  def master(self, task_type=None, task_id=None, rpc_layer=None):
    ...
    session_master = self._get_value_in_config(_SESSION_MASTER_KEY)
